...
public class DynamicActivitiProcessTest {
    ...
    protected ProcessEngine initProcessEngine() {
     ...
     */
    @Test
    public void testGetModelXml() throws Exception {
        ProcessEngine processEngine = initProcessEngine();
        InputStream processBpmn = processEngine.getRepositoryService().getResourceAsStream("5001", "dynamic-model.bpmn");
        String xml = StreamUtils.copyToString(processBpmn, Charset.forName("UTF-8"));
        StreamUtils.copy(processBpmn, new FileOutputStream(new File("diagram.png")));
     ...
     */
    @Test
    public void testGetModelImg() throws Exception {
        ProcessEngine processEngine = initProcessEngine();
        InputStream processDiagram = processEngine.getRepositoryService().getProcessDiagram("Expense:1:4");
        Assert.assertNotNull(processDiagram);
        StreamUtils.copy(processDiagram, new FileOutputStream(new File("diagram.png")));
    ...
    public void testDynamicDeploy() throws Exception {
        ...
        // 4. Start a process instance  启动一个流程处理实例
